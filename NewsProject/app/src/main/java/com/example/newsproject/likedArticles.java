...
public class likedArticles extends AppCompatActivity {
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful())
                    {
                        ...
                        Toast.makeText(likedArticles.this, "Registration successful", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                        progressDialog.dismiss();
                        Toast.makeText(likedArticles.this, "" + task.getException(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    private void sendUserToNextActivity() {
        Intent intentToSendUserToEnterPreferences = new Intent(likedArticles.this, EnterPreferences.class);
